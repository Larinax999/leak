    ...
    function Library:CreateWindow(Config, Parent)
        if game.CoreGui:FindFirstChild(Config.GameTypeName) then
            game.CoreGui:FindFirstChild(Config.GameTypeName):Destroy()
        end
    	local WindowInit = {}
    	...
    	Screen.Name =  Config.GameTypeName
    	Screen.Parent = Parent
    	Topbar.WindowName.Text = Config.WindowName
		Topbar.WindowName.RichText = true
    	...
    	function WindowInit:CreateTab(Name)
    		...
    		function TabInit:CreateSection(Name)
    			...
    			function SectionInit:CreateLabel(Name,Side)
    				local LabelInit = {}
    				...
    				Label.Text = Name
					Label.RichText = true
					if tostring(Side) == "1" then
						Label.TextXAlignment = Enum.TextXAlignment.Left
					elseif tostring(Side) == "1" then
    			...
    			function SectionInit:CreateDropdown(Name, OptionTable, Callback, InitialValue)
    				...
    				function DropdownInit:AddOption(OptionTable,Callback)
    			...
    			function SectionInit:CreateColorpicker(Name,Callback)
    				...
    				local function UpdateColor()
    					...
    					Callback(math.round(Colorpicker.Color.BackgroundColor3.R* 255) .. "," .. math.round(Colorpicker.Color.BackgroundColor3.G * 255) .. "," .. math.round(Colorpicker.Color.BackgroundColor3.B * 255))
    				end
