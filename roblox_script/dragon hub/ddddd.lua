if placeId ==  2753915549 then
	spawn(function()
	   game:GetService("RunService").Stepped:Connect(function()
		   if game.Players.LocalPlayer.Character:FindFirstChild("Movement") then
 ...
 local win = DiscordLib:Window(" Dragon Hub | Blox Fruit")
   ...
   function CheckQuest()
	  ...
	  if NewWorld then
		 ...
		 elseif MyLevel == 1200 or MyLevel <= 1249 then 
			   ...
			   TPQuest = CFrame.new(-5431.09473, 15.9868021, -5296.53223, 0.831796765, 1.15322464e-07, -0.555080295, -1.10814341e-07, 1, 4.17010995e-08, 0.555080295, 2.68240168e-08, 0.831796765)
			   TPMonster = CFrame.new(-5169.71729, 34.1234779, -4669.73633, -0.196780294, 0, 0.98044765, 0, 1.00000012, -0, -0.98044765, 0, -0.196780294)
   ...
   AutoFram:Toggle("Auto Saber",false,function(t)
	_G.saber = t
 end)
 ...
 spawn(function()
		  ...
		  for i,v in pairs(game:GetService("Workspace"):GetDescendants()) do
			 ...
			 if game:GetService("Workspace").Enemies:FindFirstChild("Mob Leader [Lv. 120] [Boss]") then
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				   ...
				   until _G.saber == false or v.Humanoid.Health <= 0
				   game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress","PlaceRelic")
				end
			 end
			 else
				game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2848.8383789063, 7.4180507659912, 5337.88671875)
			 end
			 if game:GetService("Workspace").Map.Jungle.Final.Part.Transparency == 1 then
				if game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert [Lv. 200] [Boss]") then
				   ...
				   game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1399.0661621094, 29.877805709839, 15.820601463318)
				end
		  end
		  end
		 end
   ...
   stat:Toggle("Gun",false,function(t)
	   _G.Gun = t
	   end)
	   spawn(function()
   while wait() do
   ...
   stat:Toggle("Blox Fruit",false,function(t)
	   _G.BloxFruit = t
	   end)
	   spawn(function()
   while wait() do
   if _G.BloxFruit then
   local string_1 = "AddPoint";
