if game:GetService("Players").LocalPlayer.Character.Services:FindFirstChild("Client") then
  ...
  local tab = serv:Channel("Main")
    ...
    elseif lvl >= 725 and lvl <= 799 then
        ...
        removequest = "Beli 5K"
     elseif lvl >= 800 and lvl <= 849  then
        namemobs = "Sky Soldier [Lv. 800]"
        levelquest = 800
        CFrameQuest = CFrame.new(-1253.40295, 201.045959, 4579.02148, -0.829036593, 0, -0.559194624, 0, 1, 0, 0.559194624, 0, -0.829036593)
        removequest = "Beli 5.25K"
    elseif lvl >= 850 and lvl <= 949  then
        namemobs = "Ball Man [Lv. 850]"
        levelquest = 850
        CFrameQuest = CFrame.new(-817.136475, 386.808319, 4744.53516, -0.5592103, 0, 0.829025805, 0, 1, 0, -0.829025805, 0, -0.5592103)
        removequest = "Beli 5.5K"
    elseif lvl >= 950 and lvl <= 999  then
        namemobs = "Rumble Man [Lv. 900]"
        levelquest = 950
        CFrameQuest = CFrame.new(-859.216064, 386.823547, 4880.21582, 0.461702704, 0, 0.887034833, 0, 1, 0, -0.887034833, 0, 0.461702704)
  ...
  while game:GetService("RunService").RenderStepped:wait() do
    if _G.Enma then
      pcall(function()
        equip()
          for i,v in pairs(game:GetService("Workspace").Monste.Boss:GetDescendants()) do
  ...
  tab:Toggle("ServerHop-Enma",false,function(t)
    _G.SeverHopEnma = t
  end)
  
  spawn(function()
    while wait() do
      if _G.SeverHopEnma then
        if not game:GetService("ReplicatedStorage").MOB.Boss:FindFirstChild("King Samurai [Lv. 3500]") then
  ...
  tab:Toggle("Auto-SeaKing",false,function(t)
    _G.SeaKing2 = t
  end)
  ...
  tab:Toggle("ServerHop-SeaKing",false,function(t)
    _G.SeverHopSea = t
  end)
  ...
  local Arena = serv:Channel("Dungeon")
  Arena:Toggle("Auto-Dungeon",false,function(t)
    Dungeon = t
  end)
  ...
  while game:GetService("RunService").RenderStepped:wait() do
    if Dungeon then
      ...
      elseif game.Players.LocalPlayer.Character.Humanoid.Health >= 40000 then
  ...
  Arena:Slider("Distance",-100,100,8,function(t)
    diss1 = t
  end)
  -----------------Teleport DevilFruite------------------
   local Mis = serv:Channel("Misc")
   Mis:Toggle("Teleport DevilFruite",false,function(t)
      TPF = t
      while wait() do
          if TPF then
