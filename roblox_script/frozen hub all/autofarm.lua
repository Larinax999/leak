if game.CoreGui:FindFirstChild("FrozenHub") then
	game.CoreGui:FindFirstChild("FrozenHub"):Destroy()
end
...
local Tables = BMCX:addPage("TP", 5012544693)
local Shelves = Tables:addSection("Tpm"):addButton("Remove Level Barriers", function(t)
    end)